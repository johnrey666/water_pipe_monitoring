...
import '../meter_reader_home.dart';

class MeterReaderLoginPage extends StatefulWidget {
  const MeterReaderLoginPage({super.key});

  @override
  State<MeterReaderLoginPage> createState() => _MeterReaderLoginPageState();
}

class _MeterReaderLoginPageState extends State<MeterReaderLoginPage> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (role != 'Meter Reader' && role != 'Meter_Reader') {
        await FirebaseAuth.instance.signOut();
        throw Exception('Wrong user access. This is for Meter Readers only.');
      }
      ...
      // Navigate to meter reader home
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (_) => const MeterReaderHomePage()),
        (route) => false,
      );
                      ...
                      FadeInDown(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Sign in to record water meter readings',
                              style: GoogleFonts.poppins(
                                fontSize: 16,
                                color: Colors.grey.shade600,
                              ),
